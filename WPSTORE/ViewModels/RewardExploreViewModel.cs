...
{
    public class RewardExploreViewModel : BaseViewModel
    {
        ...
        public RewardExploreViewModel(INavigationService navigationService, IAppService appService) : base(navigationService)
        {
        ...
        public async Task LoadExchangeRewards()
        {
            IsBusy = true;
            RewardsList = await _appService.GetExchangeVouchers();
            IsBusy = false;
        }
        private IEnumerable<ExchangeVoucher> _listExchangeVoucher;
        public IEnumerable<ExchangeVoucher> RewardsList
        {
