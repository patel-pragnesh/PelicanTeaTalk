    ...
    public class CustomListviewRenderer : ListViewRenderer
    {
        ...
        private void TvDelegate_OnScrolled(object sender, EventArgs e)
        {
            if(Control.ContentOffset.Y<0)
                ...
                CustomListview.OnScrollChanged(Source, new Controls.Actions.ScrollChangedEventArgs(0, 0, 0, (int)(-Control.ContentOffset.Y* Xamarin.Essentials.DeviceDisplay.MainDisplayInfo.Density)));
        }
